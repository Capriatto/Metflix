...
public class RegistroCliente extends JFrame {
	...
	public RegistroCliente() {
		...
		JLabel lblRegistroEmpleado = new JLabel("Registro Cliente");
		...
		txtCedula.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				co.edu.uniquindio.com.Cliente empleado = Principal.getInstancia()
						.buscarClienteId(txtCedula.getText().toString());
				if (empleado != null) {
		...
		btnGuardar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					Principal.getInstancia().registroCliente(cedula, apellido, contrasena, correo, estado, nombre,
							usuario);
