...
public class RegistrarPelicula extends JFrame {
	...
	public RegistrarPelicula() {
		...
		JLabel lblLanzamieto = new JLabel("Lanzamieto");
		...
		JLabel label_7 = new JLabel("Confirmacion");
		label_7.setFont(new Font("Berlin Sans FB", Font.PLAIN, 14));
		label_7.setBounds(12, 275, 354, 16);
		panel.add(label_7);
		
		txtPrecio = new JTextField();
		txtPrecio.setColumns(10);
		txtPrecio.setBounds(142, 141, 177, 22);
		panel.add(txtPrecio);
		
		txtDescripcion = new JTextField();
		txtDescripcion.setColumns(10);
		txtDescripcion.setBounds(142, 180, 177, 55);
